...
export const schemas = {
	createNode: z.object({
		...
		temporal: temporalSchema.describe(
	...
	updateNode: z.object({
		...
		temporal: temporalSchema.describe("Updated temporal metadata"),
		reason: z
			.string()
			.optional()
...
export type CreateNodeInput = SchemaInputs["createNode"];
export type UpdateNodeInput = SchemaInputs["updateNode"];
export type AddLinkInput = SchemaInputs["addLink"];
export type UpdateLinkInput = SchemaInputs["updateLink"];
export type SearchNodesInput = SchemaInputs["searchNodes"];
export type GetContextInput = SchemaInputs["getContext"];
export type DeleteNodeInput = SchemaInputs["deleteNode"];
export type DeleteLinkInput = SchemaInputs["deleteLink"];
export type WalkGraphInput = SchemaInputs["walkGraph"];
