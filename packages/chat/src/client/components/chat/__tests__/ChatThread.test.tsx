...
vi.mock("@assistant-ui/react", () => ({
	ThreadPrimitive: {
		...
		Viewport: (props: any) => (
			<div data-testid="viewport">{props.children}</div>
		),
...
vi.mock("../UserMessage.js", () => ({
	UserMessage: () => <div data-testid="user-msg" />,
}));
vi.mock("../AssistantMessage.js", () => ({
	AssistantMessage: () => <div data-testid="assistant-msg" />,
}));
vi.mock("../EditComposer.js", () => ({
	EditComposer: () => <div data-testid="edit-composer" />,
}));
vi.mock("../ReconnectStreamView.js", () => ({
	ReconnectStreamView: () => <div data-testid="reconnect-stream" />,
}));
